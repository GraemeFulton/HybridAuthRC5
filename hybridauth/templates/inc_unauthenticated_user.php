...
$register_return= BASEURL."index.php?page=register";
...
<script src="<?php echo $widgetURL; ?>js/jquery.min.js"></script> 	
       ...
       <a href="<?php echo $widgetAuthURL; ?>?_ts=<?php echo time(); ?>&return_to=<?php echo $register_return; ?>"  class='widget_link' title="HybridAuth Social Sign On Widget">Register with your Social ID (Facebook, Twitter, LinkedIn etc..)</a>
			</td>
		  </tr>
		</table> 
<hr>
