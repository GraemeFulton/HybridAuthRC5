...
$return_register= BASEURL."index.php?page=login";
?>
<script src="<?php echo $widgetURL; ?>js/jquery.min.js"></script> 
       ...
       <a href="<?php echo $widgetURL; ?>?_ts=<?php echo time(); ?>&return_to=<?php echo $return_register;?>"  class='widget_link' title="HybridAuth Social Sign On Widget">Sign in with your Social ID (Facebook, Twitter, LinkedIn, etc...)</a>
			</td>
		  </tr>
		</table> 
		<hr>
